...
export const COLOR_THEME_DARK_INITIAL_COLORS = {
       'activityBar.activeBorder': '#82007E',
       'activityBar.background': '#2A0C3B',
       'activityBar.border': '#431E53',
       'activityBar.foreground': '#FFFFFF',
       'activityBar.inactiveForeground': '#E1E1E1',
       'editorGroup.border': '#333333',
       'editorGroupHeader.tabsBackground': '#2A0C3B',
       'editorGroupHeader.tabsBorder': '#431E53',
       'statusBar.background': '#2A0C3B',
       'statusBar.border': '#431E53',
       'statusBar.foreground': '#E1E1E1',
       'statusBar.noFolderBackground': '#431E53',
       'tab.activeBackground': '#431E53',
       'tab.activeBorder': '#431E53',
       'tab.activeBorderTop': '#82007E',
       'tab.activeForeground': '#FFFFFF',
       'tab.border': '#5B2F6A',
       'textLink.foreground': '#82007E',
       'titleBar.activeBackground': '#2A0C3B',
       'titleBar.activeForeground': '#E1E1E1',
       'titleBar.border': '#431E53',
       'titleBar.inactiveBackground': '#431E53',
       'titleBar.inactiveForeground': '#999999',
       'welcomePage.tileBackground': '#431E53'
};
